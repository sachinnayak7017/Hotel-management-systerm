...
public class Dashboard extends JFrame{
    ...
    public Dashboard() {
        ...
        Image i2 = i1.getImage().getScaledInstance(1950, 700,Image.SCALE_DEFAULT);
        ImageIcon i3 = new ImageIcon(i2); 
	JLabel NewLabel = new JLabel(i3);
	NewLabel.setBounds(0, 0, 1950, 700); 
        add(NewLabel);

        JLabel AirlineManagementSystem = new JLabel("NAYAK GROUP WELCOMES YOU");
