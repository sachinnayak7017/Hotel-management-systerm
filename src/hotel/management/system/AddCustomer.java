...
public class AddCustomer extends JFrame {
	...
	public AddCustomer() throws SQLException {
		...
		contentPane.add(lblName);
                ...
                lblId.setFont(new Font("Yu Mincho", Font.PLAIN, 18));
		...
		JLabel lblName_1 = new JLabel("Name ");
                lblName_1.setFont(new Font("Yu Mincho", Font.PLAIN, 18));
		...
		JLabel lblGender = new JLabel("Gender ");
                lblGender.setFont(new Font("Yu Mincho", Font.PLAIN, 18));
		...
		JLabel lblCheckInStatus = new JLabel("Checked-In ");
                lblCheckInStatus.setFont(new Font("Yu Mincho", Font.PLAIN, 18));
		lblCheckInStatus.setBounds(35, 316, 200, 16);
		contentPane.add(lblCheckInStatus);
                Date date =new Date();
                checkintime= new JLabel("" +date );
                checkintime.setFont(new Font("Yu Mincho", Font.PLAIN, 16));
		...
		JLabel lblDeposite = new JLabel("Deposit ");
                lblDeposite.setFont(new Font("Yu Mincho", Font.PLAIN, 18));
